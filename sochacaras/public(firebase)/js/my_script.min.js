...
function uploadFile(){var a=selectedFile.name,c=firebase.storage().ref("/fotos-chacaras/"+a).put(selectedFile);c.on("state_changed",function(a){},function(a){},function(){var a=firebase.database().ref("ChacarasPendentes/").push().key,d={},e={imageURL:c.snapshot.downloadURL,Nome:$("#chacNome").val(),Dono:$("#chacDono").val(),userTelCont:$("#chacTel").val(),Endereco:$("#chacEnd").val(),Numero:$("#chacNum").val(),Complemento:$("#chacComp").val(),CEP:$("#chacCEP").val(),Cidade:$("#chacCity").val(),Estado:$("#chacEstate").val(),
valorAluguel:$("#chacValor").val(),Quartos:$("#chacQuartos").val(),Camas:$("#chacCamas").val(),Banheiros:$("#chacBanheiros").val(),Churrasqueiras:$("#chacChurrasqueiras").val(),Piscinas:$("#chacPiscinas").val(),Descricao:$("#chacDescricao").val(),Contrato:"no",totalEstrelas:0,mediaEstrelas:0,qtdVotos:0,userID:user.uid,userName:user.displayName,userFotoURL:user.photoURL};d["/ChacarasPendentes/"+a]=e;firebase.database().ref().update(d);completeCadChac();displayChacNotification()})}
function uploadFileVIP(){var a=selectedFile.name,c=firebase.storage().ref("/fotos-chacaras/"+a).put(selectedFile);c.on("state_changed",function(a){},function(a){},function(){var a=firebase.database().ref("ChacarasPendentes/").push().key,d={},e={imageURL:c.snapshot.downloadURL,Nome:$("#chacNome").val(),Dono:$("#chacDono").val(),userTelCont:$("#chacTel").val(),Endereco:$("#chacEnd").val(),Numero:$("#chacNum").val(),Complemento:$("#chacComp").val(),CEP:$("#chacCEP").val(),Cidade:$("#chacCity").val(),
Estado:$("#chacEstate").val(),valorAluguel:$("#chacValor").val(),Quartos:$("#chacQuartos").val(),Camas:$("#chacCamas").val(),Banheiros:$("#chacBanheiros").val(),Churrasqueiras:$("#chacChurrasqueiras").val(),Piscinas:$("#chacPiscinas").val(),Descricao:$("#chacDescricao").val(),Contrato:"yes",totalEstrelas:0,mediaEstrelas:0,qtdVotos:0,userID:user.uid,userName:user.displayName,userFotoURL:user.photoURL};d["/ChacarasPendentes/"+a]=e;firebase.database().ref().update(d);completeCadChac();displayChacNotification()})}
...
$(Y).html("Valor do Aluguel: "+b.valorAluguel);var Z=document.createElement("p");$(Z).addClass("contentInfo");$(Z).html("Propriet\u00e1rio: "+b.Dono);var aa=document.createElement("p");$(aa).addClass("contentInfo");$(aa).html("Telefone: "+b.userTelCont);var ba=document.createElement("img");ba.src=b.userFotoURL;$(ba).addClass("userFotoChacPage");var ga=document.createElement("img");ga.src="imagens/icon01.jpg";var ha=document.createElement("img");ha.src="imagens/icon02.jpg";var ia=document.createElement("img");
ia.src="imagens/icon03.jpg";var ja=document.createElement("img");ja.src="imagens/icon04.jpg";var ka=document.createElement("img");ka.src="imagens/icon05.jpg";if("yes"==b.Contrato){var ca=document.createElement("img");ca.src="imagens/icon06.jpg";$(ca).addClass("contratoIcon");var y=document.createElement("button");y.innerHTML="Tenho Interesse";$(y).addClass("btn btn-primary chacBtn");$(y).on("click",function(a){$("#chacAluguelModalContract").modal("show")})}else{var z=document.createElement("button");
z.innerHTML="Tenho Interesse";$(z).addClass("btn btn-primary chacBtn");$(z).on("click",function(a){$("#chacAluguelModal").modal("show")})}var da=document.createElement("p");$(da).addClass("starsInfo");$(da).html("Avalie esta ch\u00e1cara: ");var ea=document.createElement("ul");$(ea).addClass("starUl");var A=document.createElement("button");A.innerHTML="Votar";$(A).addClass("btn btn-primary starBtn");$(A).on("click",function(){$(".starLi").removeClass("active");$(".starLi").removeClass("secondary-active");
alert("Sua vota\u00e7\u00e3o foi realizada com Sucesso!")});var B=document.createElement("button");B.innerHTML="Limpar";$(B).addClass("btn btn-primary starBtn");$(B).on("click",function(){$(".starLi").removeClass("active");$(".starLi").removeClass("secondary-active")});var fa=document.createElement("li");$(fa).addClass("starLi");var v=document.createElement("label");$(v).attr("for","st1");var f=document.createElement("i");$(f).addClass("fa fa-star");$(f).attr("aria-hidden","");$(v).append(f);f=document.createElement("input");
$(f).attr("type","radio");$(f).attr("name","star");$(f).attr("value","1");f.id="st1";$(fa).append(v,f);v=document.createElement("li");$(v).addClass("starLi");f=document.createElement("label");$(f).attr("for","st2");var g=document.createElement("i");$(g).addClass("fa fa-star");$(g).attr("aria-hidden","");$(f).append(g);g=document.createElement("input");$(g).attr("type","radio");$(g).attr("name","star");$(g).attr("value","1");g.id="st2";$(v).append(f,g);f=document.createElement("li");$(f).addClass("starLi");
g=document.createElement("label");$(g).attr("for","st3");var h=document.createElement("i");$(h).addClass("fa fa-star");$(h).attr("aria-hidden","");$(g).append(h);h=document.createElement("input");$(h).attr("type","radio");$(h).attr("name","star");$(h).attr("value","1");h.id="st3";$(f).append(g,h);g=document.createElement("li");$(g).addClass("starLi");h=document.createElement("label");$(h).attr("for","st4");var l=document.createElement("i");$(l).addClass("fa fa-star");$(l).attr("aria-hidden","");$(h).append(l);
l=document.createElement("input");$(l).attr("type","radio");$(l).attr("name","star");$(l).attr("value","1");l.id="st4";$(g).append(h,l);h=document.createElement("li");$(h).addClass("starLi");l=document.createElement("label");$(l).attr("for","st5");var u=document.createElement("i");$(u).addClass("fa fa-star");$(u).attr("aria-hidden","");$(l).append(u);u=document.createElement("input");$(u).attr("type","radio");$(u).attr("name","star");$(u).attr("value","1");u.id="st5";$(h).append(l,u);$(ea).append(da,
fa,v,f,g,h);$(".starLi").on("click",function(){$(this).addClass("active");$(this).prevAll().addClass("secondary-active")});b=b.mediaEstrelas;if(5==b){var n=document.createElement("img");n.src="imagens/star1.png";var p=document.createElement("img");p.src="imagens/star1.png";var q=document.createElement("img");q.src="imagens/star1.png";var r=document.createElement("img");r.src="imagens/star1.png";var t=document.createElement("img");t.src="imagens/star1.png"}4==b&&(n=document.createElement("img"),n.src=
"imagens/star1.png",p=document.createElement("img"),p.src="imagens/star1.png",q=document.createElement("img"),q.src="imagens/star1.png",r=document.createElement("img"),r.src="imagens/star1.png",t=document.createElement("img"),t.src="imagens/star0.png");3==b&&(n=document.createElement("img"),n.src="imagens/star1.png",p=document.createElement("img"),p.src="imagens/star1.png",q=document.createElement("img"),q.src="imagens/star1.png",r=document.createElement("img"),r.src="imagens/star0.png",t=document.createElement("img"),
...
r=document.createElement("img"),r.src="imagens/star0.png",t=document.createElement("img"),t.src="imagens/star0.png");0==b&&(n=document.createElement("img"),n.src="imagens/star0.png",p=document.createElement("img"),p.src="imagens/star0.png",q=document.createElement("img"),q.src="imagens/star0.png",r=document.createElement("img"),r.src="imagens/star0.png",t=document.createElement("img"),t.src="imagens/star0.png");b=document.createElement("button");b.innerHTML="Visualizar todas as informa\u00e7\u00f5es";
$(b).addClass("btn btn-primary collapsible");$(b).on("click",function(a){mostrarChac()});$("#chacList").append(d);$(C).append(n,p,q,r,t);$(D).append(ea,A,B);$(E).append(z,y);$(m).append(G);$(F).append(H,J,O,ca);$(x).append(I,K,L,M,N,P,Q,X,Y,ga,R,ha,S,ia,T,ja,U,ka,V,W,Z,aa,ba,D,E);$(w).append(F,C,b,x);$(k).append(m,w)}})}
function mostrarChac(){var a=document.getElementsByClassName("collapsible"),c;for(c=0;c<a.length;c++)a[c].addEventListener("click",function(){this.classList.toggle("active");var a=this.nextElementSibling;a.style.maxHeight=a.style.maxHeight?null:a.scrollHeight+"px"})}
...
a)})}}
function displayAluguelNotification(){if("serviceWorker"in navigator){var a={body:"Certifique-se que vo\u00e7\u00ea entrou contato com o Propriet\u00e1rio para que possam resolver os detalhes da loca\u00e7\u00e3o da ch\u00e1cara!",icon:"/imagens/icons/app-icon-96x96.png",dir:"ltr",lang:"pt-BR",vibrate:[100,50,200],badge:"/imagens/icons/app-icon-96x96.png",tag:"alugChac-notification",renotify:!0,actions:[{action:"continue",title:"Ir para a p\u00e1gina",icon:"/imagens/icons/app-icon-96x96.png"},{action:"cancel",
title:"Fechar",icon:"/imagens/icons/app-icon-96x96.png"}]};navigator.serviceWorker.ready.then(function(c){c.showNotification("Voc\u00ea alugou uma Ch\u00e1cara em nosso App!",a)})}console.log("Usu\u00e1rio escolheu a ch\u00e1cara!!!");$("#chacAluguelModalContract").modal("hide")}
